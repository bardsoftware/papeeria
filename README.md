...
2. Скачать корпус с помощью команды `python3.4 /data/papeeria`. Дополнительные пояснения к этой и следующим командам можете получить, запустив их с аргументами -h или --help.
